namespace Vsite.CSharp.Iznimke
{
    ...
    class BacanjeIznimkeUPozvanojMetodi
    {
        static void Main()
        {
            // DID_IT:060 Prije izvođenja programa pokušati predvidjeti tok programa. Pokrenuti program i provjeriti ispravnost pretpostavke.
            Metoda1(8, 3);
            Console.WriteLine();
            Metoda1(5, 0);
        ...
        public static void Metoda1(int djeljenik, int djeljitelj)
        {
            ...
            // DID_IT:062 Kako bi izgledalo izvođenje programa kada bi se izostavio donji blok hvatanja? Zakomenirajte ga i pokrenite program.
            //catch (Exception e)
            //{
        ...
        static void Metoda2(int djeljenik, int djeljitelj)
        {
            ...
            // DID_IT:061 Kako bi izgledalo izvođenje programa kada bi se izostavio donji blok hvatanja? Zakomenirajte ga i pokrenite program.
