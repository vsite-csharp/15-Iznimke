...
namespace Vsite.CSharp.Iznimke
{
    class VišestrukiBlokoviCatch
    {
        ...
        public static void HvatanjeIznimkePremaTipu(Exception iznimka)
        {
            ...
            // Složiti niz blokova catch tipa Exception, ArgumentOutOfRangeException i ArgumentException.
            // U blokove catch dodati ispise koristeći gornje formate te provjeriti koja će iznimka biti uhvaćena u kojem bloku.
