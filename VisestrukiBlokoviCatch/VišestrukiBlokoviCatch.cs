namespace Vsite.CSharp.Iznimke
{
    static class VišestrukiBlokoviCatch
    {
        ...
        public static void HvatanjeIznimkePremaTipu(Exception iznimka)
        {
            ...
            catch (ArgumentOutOfRangeException e) { Console.WriteLine(FormatBlokaArgumentOutOfRangeException, e.GetType().Name); }
            catch (ArgumentException e) { Console.WriteLine(FormatBlokaArgumentException, e.GetType().Name);}
