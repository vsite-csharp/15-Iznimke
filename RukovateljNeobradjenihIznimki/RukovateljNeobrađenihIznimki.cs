...
namespace Vsite.CSharp.Iznimke
{
    ...
    static class RukovateljNeobrađenihIznimki
    {
        ...
        public static void Main()
        {
            ...
            // Pogledati što program radi, pokrenuti ga bez Debuggiranja (Ctrl + F5) i provjeriti ispis.
            // Odkomentirati donju naredbu te događaju UnhandledException pridružiti rukovatelja (handlera) koji će pozvati gornju metodu ZapišiNeuhvaćenuIznimku.
        ...
        private static void ZapišiNeuhvaćenuIznimku(object sender, UnhandledExceptionEventArgs e)
        {
