...
namespace Vsite.CSharp.Iznimke
{
    ...
    static class RukovateljNeobrađenihIznimki
    {
        ...
        public static void Main()
        {
            ...
            AppDomain.CurrentDomain.UnhandledException += ZapisiNeuhvacenuIznimku;
        ...
        private static void ZapisiNeuhvacenuIznimku(object sender, UnhandledExceptionEventArgs e)
        {
