...
namespace Vsite.CSharp.Iznimke
{
    class OdvajanjeGlavneLogike
    {
        ...
        {
            // T Pokrenuti program i provjeriti što će se dogoditi.
            // T Donje petlje obuhvatiti try-catch blokom koji će prekinuti daljnje računanje kada bude bačena iznimka. Unutar bloka hvatanja ispisati poruku o pogrešci.
            try
            {
